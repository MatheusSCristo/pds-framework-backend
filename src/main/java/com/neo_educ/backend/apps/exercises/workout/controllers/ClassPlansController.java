...
import com.neo_educ.backend.apps.exercises.workout.dto.ClassPlansCreateDTO;
import com.neo_educ.backend.apps.exercises.workout.dto.ClassPlansIaContentDTO;
...
import com.neo_educ.backend.apps.exercises.personal.entity.TeacherEntity;
...
public class ClassPlansController {
    ...
    public ResponseEntity<ClassPlansResponseDTO> generateIA(@PathVariable Long id, @RequestBody ClassPlansIaContentDTO body) {
        WorkoutPlanService concreteService = (WorkoutPlanService) appFactory.createSessionService();
